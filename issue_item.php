...
if($_SESSION['role'] == 'member' || $_SESSION['role'] == 'S' ) {
    ...
    <form onsubmit="return fn_search_mem();" action="<?php $_PHP_SELF ?>" method="post" name="search_mem"
        ...
        <h2 class="form-signin-heading" style="text-align:center; width:700px;">Issue Item</h2>
        ...
        <div class="modal-body">
            ...
            if (isset($_SESSION['error']) && $_SESSION['error'] != '') {
                ...
                if ($_SESSION['result_exists'] == 'n') {
                    echo '<div class="txt-heading" ><b>No items issued to the member as of now </b><a id="btnEmpty" href="issue_item2.php?id=' . $row['member_id'] . '" name="issue_item"  ><b>Proceed to issue</b></a></div>';
                } else {
                    if ($_SESSION['result_exists'] == 'y') {
                        echo '<div class="txt-heading" ><b>Items already issued to the member </b><a id="btnEmpty" href="issue_item2.php?id=' . $row['member_id'] . '" name="issue_item"  ><b>Proceed to issue</b></a></div>';
                    } else {
    ...
    <script>
        ...
        function get_selected_members_info(rad) {
            ...
            if (rad.value == '') {
                ...
                xmlhttp.open("GET", "get_issued_items7.php?id=" + rad.value, true);
                xmlhttp.send();
            }
